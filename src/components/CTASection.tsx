...
const ctaCardVariants: Variants = {
  ...
  visible: {
    ...
    scale: 1,
    y: 0,
    transition: { type: "spring", damping: 20, stiffness: 100, duration: 0.8, delay: 0.2, staggerChildren: 0.15 },
  },
};
...
const actionCardVariants: Variants = {
  ...
  visible: {
    ...
    x: 0,
    scale: 1,
    transition: { type: "spring", damping: 15, stiffness: 100, delay: 0.4, staggerChildren: 0.1 },
  },
};
...
const CTASection = () => {
  return (
    <motion.section 
      className="py-28 relative overflow-hidden bg-gray-950 text-white" // Assuming a base theme
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <motion.div 
          ...
          variants={bgBlobVariants(1, 25)} // Different delay and duration
          animate="animate"
        />
        <motion.div 
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10">
        <motion.div // Main CTA Card container - this will be animated first
          variants={ctaCardVariants}
          // This will be triggered by the parent section's whileInView
        >
          <div className="relative flex flex-col lg:flex-row lg:items-center gap-10 p-10 md:p-16 rounded-3xl neo-glow overflow-hidden shadow-2xl shadow-blue-500/10">
            ...
            <motion.div 
              ...
              // Stagger children of this left content block
              variants={{ visible: { transition: { staggerChildren: 0.1 } } }} 
            >
              <motion.div 
                className="inline-flex items-center justify-center px-4 py-1.5 space-x-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm text-xs font-medium uppercase tracking-wider text-blue-300 shadow-md" // Enhanced neo-frost
              ...
              <motion.ul 
                ...
                variants={{ visible: { transition: { staggerChildren: 0.1 } } }} // Stagger list items
              >
                {[
                  ...
                  <motion.li 
                    key={i} 
                    className="flex items-center gap-3 text-white/70" // Increased gap
                    variants={listItemVariants}
                  >
                    <motion.div 
                      className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-500/20 border border-blue-500/30 shrink-0" // Increased size & border
                      variants={contentItemVariants} // Pop in
                    >
            ...
            <motion.div 
              className="relative flex flex-col gap-4 min-w-[300px] lg:min-w-[350px] bg-black/20 border border-white/10 p-8 rounded-2xl shadow-2xl backdrop-blur-lg neo-frost-strong" // Enhanced neo-frost
              variants={actionCardVariants} // This card animates in after the left side (due to parent stagger)
                                            // and then staggers its own children
            >
              {/* Optional subtle background for this card too */}
              {/* <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-primary/5 to-purple-500/5 rounded-2xl opacity-50"></div> */}
                  ...
                  <div className="flex items-center justify-center mb-1 space-x-1">
                    {[1,2,3].map(num => (
                        <motion.div 
                            ...
                            variants={contentItemVariants} // Staggered by parent
